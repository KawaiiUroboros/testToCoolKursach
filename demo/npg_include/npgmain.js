...
let app = (() => {
  ...
  function GetPictureK(parent, mainPicture, value) {
    ...
    path = pathes[0] + "/testToCoolKursach/" + pathes[1] + "/" + pathes[2] + "/" + endPath + "/" + pathes[4] + "/" + pathes[5];
    return path;
  }
  function GetPictureG(parent, mainPicture, value) {
    ...
    path = pathes[0] + "/testToCoolKursach/" + pathes[1] + "/" + pathes[2] + "/" + pathes[3] + "/" + endPath + "/" + pathes[5];
    return path;
  }
  function GetPictureC(parent, mainPicture, value) {
    ...
    path = pathes[0] + "/testToCoolKursach/" + pathes[1] + "/" + pathes[2] + "/" + pathes[3] + "/" + pathes[4] + "/" + endPath;
    return path;
  }
